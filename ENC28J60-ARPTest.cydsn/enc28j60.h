...
*
* Returns:
*   TRUE - if the Packet was successfully transmitted.
*   FALSE - if the Packet was not successfully transmistted.
*
*******************************************************************************/
...
*
* Parameters:
*   packet - a buffer of data that will hold the packet read.
*	maxLen - Maximum length of the packet that will be read.
*
* Returns:
*   the length of the packet read into uip_buf.
*
*******************************************************************************/
...
/*uip_len holds the length of the packet read into uip_buf*/
extern unsigned int uip_len;

extern unsigned char* uip_appdata;

/*This is the PSoC side buffer for packet transactions*/
