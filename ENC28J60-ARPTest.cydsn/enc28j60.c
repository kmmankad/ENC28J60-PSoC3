/* Basic ENC28J60 Driver Code for PSoC3
 ...
 Description : This file contains functions essential for 
               dealing with the ENC28J60 chip.
*/
...
Too bad these are not defined in CyTypes.h*/
#define TRUE  0
#define FALSE 1
...
static void ResetMac(void){
    ...
    /*Give it 1mS to come out of Reset.*/
    CyDelay(1);
}