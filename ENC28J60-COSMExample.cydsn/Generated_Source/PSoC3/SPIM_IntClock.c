...
{
    if (SPIM_IntClock_CLKEN & SPIM_IntClock_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void SPIM_IntClock_SetModeRegister(uint8 clkMode) 
{
    SPIM_IntClock_MOD_SRC |= clkMode & SPIM_IntClock_MODE_MASK;
}
...
*
*******************************************************************************/
void SPIM_IntClock_ClearModeRegister(uint8 clkMode) 
{
    SPIM_IntClock_MOD_SRC &= ~clkMode | ~SPIM_IntClock_MODE_MASK;
}
...
{
    return SPIM_IntClock_MOD_SRC & SPIM_IntClock_MODE_MASK;
}
...
void SPIM_IntClock_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        SPIM_IntClock_MOD_SRC =
            (SPIM_IntClock_MOD_SRC & ~SPIM_IntClock_SRC_SEL_MSK) | clkSource;
    }
