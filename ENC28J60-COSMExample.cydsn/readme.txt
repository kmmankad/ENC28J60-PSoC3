...
-This project performs a DNS Request for api.cosm.com and if successful in
 getting its IP,proceeds to make an HTTP PUT Request as follows.
-It sends a PUT Request to COSM,with the intention of updating a feed with
 its current die temperature.
